...
function installTrigger() {
  ...
  try {
    ...
    else if (process.platform === "linux") installers.installSystemd(node, reconcile);
    else if (process.platform === "win32") installers.installWindowsCodexTrigger({ log: console.log });
